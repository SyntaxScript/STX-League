ф/* ===== STX League MD — общие функции для всех страниц =====
   - Preloader
            ...
            m.innerHTML =
                '<div class="reg-closed-box">' +
                    '<div class="reg-closed-icon">' +
                        ...
                        '</svg>' +
                    '</div>' +
                    '<h3 class="reg-closed-title" data-i18n="reg.closed.title">' + t('reg.closed.title') + '</h3>' +
                    '<p class="reg-closed-hint" data-i18n="reg.closed.hint">' + t('reg.closed.hint') + '</p>' +
                    '<div class="reg-closed-actions">' +
                        '<a href="https://discord.gg/f5bZJFWW2B" target="_blank" rel="noopener" class="reg-closed-btn-discord">' +
                        ...
                        '</a>' +
                        '<a href="https://t.me/stxleague" target="_blank" rel="noopener" class="reg-closed-btn-tg">' +
