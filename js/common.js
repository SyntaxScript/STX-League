    ...
    function injectFooter() {
        ...
        footerHost.outerHTML =
            '<footer>' +
                ...
                '<div class="copy">' +
                    '<span data-i18n="foot.copy">' + t('foot.copy') + '</span>' +
                '</div>' +
                '<div class="policy-links">' +
                    '<a class="privacy-link" href="privacy.html" target="_blank" rel="noopener">Политика конфиденциальности</a>' +
                    '<a class="privacy-link" href="terms.html" target="_blank" rel="noopener">Пользовательское соглашение</a>' +
                '</div>' +
            '</footer>' +
