(function() {
    ...
    var DICT = {
        ru: {
            ...
            'page.hero.about.badge': 'STX League MD',
            'page.hero.about.title': 'О турнире',
            'page.hero.about.sub': 'Киберспортивный турнир по Counter-Strike 2 в Молдове — место, где собираются сильнейшие команды и настоящая конкуренция.',
            ...
            'page.hero.format.badge': 'Турнирный формат',
            'page.hero.format.title': 'Формат турнира',
            'page.hero.format.sub': '16 команд, жёсткая сетка, лучшие карты и максимум эмоций в каждом матче.',
            ...
            'page.hero.prizes.badge': 'Призы',
            'page.hero.prizes.title': 'Призовой фонд',
            'page.hero.prizes.sub': 'Сильнейшие команды получат достойное вознаграждение и статус победителей.',
            ...
            'page.hero.schedule.badge': 'Таймлайн события',
            'page.hero.schedule.title': 'Расписание турнира',
            'page.hero.schedule.sub': 'Подробный план дня турнира, от регистрации до награждения.',
            ...
            'page.hero.teams.badge': 'Команды',
            'page.hero.teams.title': 'Зарегистрированные команды',
            'page.hero.teams.sub': 'Список участников, прогресс регистрации и место каждого состава в турнире.',
            ...
            'page.hero.rules.badge': 'Правила',
            'page.hero.rules.title': 'Регламент турнира',
            'page.hero.rules.sub': 'Все важные условия, стандарты честной игры и порядок проведения матчей.',
            ...
            'page.hero.faq.badge': 'FAQ',
            'page.hero.faq.title': 'FAQ',
            'page.hero.faq.sub': 'Ответы на самые важные вопросы о турнире, формате и правилах.',
            ...
            'faq.q9.text':   'Если вам нужна помощь, откройте страницу «Нужна помощь?» — там есть ссылки на Telegram, Discord и другие способы связи с организаторами.',
            ...
            'page.hero.partners.badge': 'Нужна помощь?',
            'page.hero.partners.title': 'Свяжитесь с организаторами',
            'page.hero.partners.sub': 'Если у вас есть вопросы по турниру, регистрации или правилам — мы всегда на связи.',
            'partners.cta':   'Хотите стать партнёром?',
            'partners.cta.link': 'Свяжитесь с нами',
            'partners.help.title': 'Нужна помощь?',
            'partners.help.sub': 'Выберите удобный канал связи и мы ответим как можно быстрее.',
            'partners.help.telegram': 'Telegram',
            'partners.help.discord': 'Discord',
            'partners.help.note': 'Обычно отвечаем в течение нескольких часов.',
        ...
        ro: {
            ...
            'nav.rules':     'Reguli',
            'nav.faq':       'FAQ',
            'nav.partners':  'Ai nevoie de ajutor?',
            ...
            'page.hero.about.badge': 'STX League MD',
            'page.hero.about.title': 'Despre turneu',
            'page.hero.about.sub': 'Turneu de esports pe Counter-Strike 2 în Moldova — locul unde se adună cele mai puternice echipe și competiția adevărată.',
            ...
            'page.hero.prizes.badge': 'Premii',
            'page.hero.prizes.title': 'Fond de premii',
            'page.hero.prizes.sub': 'Cele mai puternice echipe vor primi o recompensă demnă și statutul de câștigători.',
            ...
            'page.hero.schedule.badge': 'Cronologia evenimentului',
            'page.hero.schedule.title': 'Programul turneului',
            'page.hero.schedule.sub': 'Planul detaliat al zilei turneului, de la înregistrare până la premiere.',
            ...
            'page.hero.teams.badge': 'Echipe',
            'page.hero.teams.title': 'Echipe înregistrate',
            'page.hero.teams.sub': 'Lista participanților, progresul înregistrării și locul fiecărei echipe în turneu.',
            ...
            'page.hero.faq.badge': 'FAQ',
            'page.hero.faq.title': 'FAQ',
            'page.hero.faq.sub': 'Răspunsuri la cele mai importante întrebări despre turneu, format și reguli.',
            ...
            'faq.q9.text':   'Dacă ai nevoie de ajutor, deschide secțiunea „Ai nevoie de ajutor?” — acolo găsești linkuri către Telegram, Discord și alte modalități de a contacta organizatorii.',
            ...
            'page.hero.partners.badge': 'Ai nevoie de ajutor?',
            'page.hero.partners.title': 'Contactează organizatorii',
            'page.hero.partners.sub': 'Dacă ai întrebări despre turneu, înregistrare sau reguli — suntem întotdeauna la dispoziție.',
            'partners.cta':   'Doriți să deveniți partener?',
            'partners.cta.link': 'Contactați-ne',
            'partners.help.title': 'Ai nevoie de ajutor?',
            'partners.help.sub': 'Alege canalul de comunicare potrivit și îți răspundem cât mai repede.',
            'partners.help.telegram': 'Telegram',
            'partners.help.discord': 'Discord',
            'partners.help.note': 'De obicei răspundem în câteva ore.',
